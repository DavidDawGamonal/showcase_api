...
/**
 * Servicio que gestiona la lógica de negocio relacionada con los likes.
 * Permite alternar el like de un usuario sobre un track, comprobar si ya
 * lo ha dado y contar el total de likes de un track.
 * Solo los usuarios registrados pueden dar like.
...
public class LikeService {
    ...
    /**
     * Alterna el like de un usuario sobre un track.
     * Si el usuario ya había dado like lo elimina, si no lo crea.
     * La unicidad usuario+track está garantizada por la restricción de la BD.
     *
     ...
     * Se usa al cargar el reproductor para pintar el corazón relleno o vacío.
     *
     ...
     * Se usa al cargar el reproductor para mostrar el contador real.
     *
     * @param idTrack ID del track
    ...
    /**
     * Devuelve el número total de likes publicados en todos los tracks que ha escuchado un usuario.
