...
/**
 * Servicio que gestiona la lógica de negocio relacionada con los likes de comentarios.
 * Permite dar y quitar likes a comentarios y consultar su estado.
 *
...
public class LikeComentarioService {
     ...
     */
    public LikeComentarioService(LikeComentarioRepository likeComentarioRepository,
