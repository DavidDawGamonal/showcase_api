 ...
 * Proporciona operaciones de autenticación y registro, incluyendo
 * el cifrado de contraseñas con BCrypt.
 *
...
public class UsuarioService {
     ...
     * BCrypt genera un hash distinto cada vez (salt aleatorio incluido),
     * por lo que no se puede revertir — solo se puede verificar con matches().
     */
    private BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();

    /**
     * Constructor que inyecta el repositorio de usuarios.
     * Spring lo resuelve automáticamente al arrancar la aplicación.
     *
    ...
    /**
     * Comprueba las credenciales de un usuario para el inicio de sesión.
     * Busca al usuario por email y verifica que la contraseña proporcionada
     * coincide con el hash almacenado en base de datos usando BCrypt.
     *
     * @param usuario Objeto Usuario con el email y la contraseña en texto plano a verificar
     * @return El objeto Usuario completo si las credenciales son correctas, null si no lo son
     */
     ...
     * Gracias a las FK con ON DELETE CASCADE definidas en la BD,
     * se eliminan automáticamente todos sus datos asociados:
     * tracks, likes, comentarios, descargas y playlists.
     *
